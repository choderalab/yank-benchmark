...
#
# Set output file
#BSUB -o BRD4-sams-boresch-dense-exact.%J.log
#
# Specify node group
...
#BSUB -J "BRD4-sams-boresch-dense-exact"

build_mpirun_configfile "yank script --yaml=sams-twostage-boresch-dense-exact.yaml"
