...
build_mpirun_configfile --hostfilepath hostfile.repex.harma --configfilepath configfile.repex.harma "yank script --yaml=repex-twostage-harmonic-auto.yaml"
mpiexec.hydra -f hostfile.repex.harma -configfile configfile.repex.harma
